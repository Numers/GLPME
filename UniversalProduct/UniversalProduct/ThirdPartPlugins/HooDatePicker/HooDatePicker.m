...
#define kHooDatePickerLabelFont [UIFont systemFontOfSize:12.0]
...
#define kHooDatePickerHighlightColor [UIColor colorWithRed:85.0/255 green:168.0/255 blue:253.0/255 alpha:1.0]
...
#define kHooDatePickerBackgroundColorLines [UIColor colorWithRed:229.0/255.0 green:229.0/255.0 blue:229.0/255.0 alpha:1.0]
...
- (NSMutableArray*)getDaysInMonth:(NSDate*)date {
    ...
    for (int i = 1; i <= daysRange.length; i++) {
        if (i<10) {
            [days addObject:[NSString stringWithFormat:@"0%d%@", i, @"日"]];
        }else{
...
- (UIView *)headerView {
    if (!_headerView) {
        ...
        NSAttributedString *cancelButtonTitle = [[NSAttributedString alloc] initWithString:kCancelButtonItemTitle attributes:@{NSForegroundColorAttributeName:self.tintColor,NSFontAttributeName:kHooDatePickerTitleFont}];
        ...
        NSAttributedString *sureButtonTitle = [[NSAttributedString alloc] initWithString:kSureButtonItemTitle attributes:@{NSForegroundColorAttributeName:self.highlightColor,NSFontAttributeName:kHooDatePickerTitleFont}];
        [sureButton setAttributedTitle:sureButtonTitle forState:UIControlStateNormal];
...
- (NSMutableArray *)months {
    ...
    for (int monthNumber = 1; monthNumber <= 12; monthNumber++) {
        ...
        if (monthNumber < 10) {
            dateString = [NSString stringWithFormat: @"0%d月", monthNumber];
        }else{
            dateString = [NSString stringWithFormat: @"%d月", monthNumber];
        }
